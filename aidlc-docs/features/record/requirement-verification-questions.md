...
## Q4. 대표 음식 이모지·대표 게시물 저장 (2026-09-04 추가)
- **답변**: **스키마 v3 + 홈 연동** — food_emoji·is_representative 컬럼, 홈 마크·메뉴 이모지는 foodEmoji 우선(없으면 스텁 랜덤) [확실]

## Q5. 시간 변경 구현 (2026-09-04 추가)
- **답변**: **Material3 TimePicker** 다이얼로그 [확실]
